    ...
    <Title title="申请信息">
      <template #content>
        ...
        >
          ...
          <!-- <el-table-column prop="description" label="退单备注" show-overflow-tooltip min-width="12%"/> -->
          <el-table-column prop="description" label="备注" min-width="12%">
            <template #default="scope">
              <el-popover
                placement="left"
...
const { returnApplyTypes, returnCheckTypes } = useCode();
const execute = ref("");
