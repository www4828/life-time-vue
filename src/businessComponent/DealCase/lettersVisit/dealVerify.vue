<template>
  <div>
    <Title title="办理结果">
      <template #content>
        <DoneForm ref="doneForm" label="办理描述" :form="state.form" nodeCode="XC202-1" />
      </template>
    </Title>
    ...
    <Title title="办结报告" v-if="is12345">
      <template #content>
        <DoneReport ref="doneReport" :case-info="props.caseInfo" :taskId="props.taskId" :node-code="['XC202-2','XC202-3','XC202-4','XC202-5']" />
      </template>
    </Title>
    <Title title="办理审核">
      <template #content>
