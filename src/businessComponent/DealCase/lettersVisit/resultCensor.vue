<template>
  <div>
    <Title title="办理结果">
      <template #content>
        <DoneForm ref="doneForm" label="办理描述" :form="state.form" nodeCode="XC300-1" />
      </template>
    </Title>
    ...
    <Title title="办结报告" v-if="is12345">
      <template #content>
        <DoneReport ref="doneReport" :case-info="props.caseInfo" :taskId="props.taskId" :node-code="['XC300-2','XC300-3','XC300-4','XC300-5']" />
      </template>
    </Title>
    <Title title="结果审查">
      <template #content>
