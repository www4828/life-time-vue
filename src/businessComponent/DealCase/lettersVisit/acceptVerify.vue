...
import { getPrevious, getAcceptCensorList, getXfAcceptCheckList } from '@/hooks/getPrevious'
...
const init = () => {
  ...
  // getXfAcceptCheckList(props.taskId).then(res=>{
  // })
}
init()
