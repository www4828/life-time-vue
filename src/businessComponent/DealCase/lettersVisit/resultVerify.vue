<template>
  <div>
    <Title title="办理结果">
      <template #content>
        <DoneForm ref="doneForm" label="办理描述" :form="state.form" nodeCode="XC302-1" />
      </template>
    </Title>
    ...
    <Title title="办结报告" v-if="is12345">
      <template #content>
        <DoneReport ref="doneReport" :case-info="props.caseInfo" :taskId="props.taskId" :node-code="['XC302-2','XC302-3','XC302-4','XC302-5']" />
      </template>
    </Title>
    <Title title="结果审核">
      <template #content>
