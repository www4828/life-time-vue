      ...
      <template #content>
        ...
        >
          <el-row>
            <el-col :span="6">
              <el-form-item label="跟踪结果" prop="result">
                <el-select v-model="caseBackCheckDto.result" placeholder="请选择">
                  <el-option
                    v-for="item in knottyTraceTypes"
                    :label="item.codeName"
            ...
            <template v-if="caseBackCheckDto.result == '3'">
              <el-col :span="6">
                <el-form-item label="转会商单位">
                  <span>{{ currentDepartmentCodeName }}</span>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item label="转会商人员">
                  <span>{{ caseBackCheckDto.applyPerson }}</span>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item label="转会商时间">
                  <span>{{ caseBackCheckDto.applyTime }}</span>
                </el-form-item>
              </el-col>
            </template>
            <template v-else>
...
const { returnApplyTypes, knottyTraceTypes } = useCode();
const execute = ref("");
