  ...
  >
    ...
    >
      <template #baseInfo>
        ...
        />
        <DBForm is-detail :task-id="form.xfTaskId" v-if="form.xfTaskId" />
        <FileAttachments
          v-if="props.taskId"
          :task-id="props.taskId"
          ref="fileAttachments"
...
import ContactDialog from "@/businessComponent/ContactDialog/xf.vue";
...
import { ref, reactive, markRaw, nextTick, watch, getCurrentInstance } from "vue";
