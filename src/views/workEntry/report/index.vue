...
const dispatchRules = reactive<FormRules>({
  ...
  firstClass: [{ required: false, message: "事项类别不能为空", trigger: "change",validator: validateFirstClass }],
...
const clear = () => {
  ...
  dispatchRules.firstClass = [
    { required: false, message: "事项类别不能为空", trigger: "change", validator: validateFirstClass },
  ];
...
const executeDepartCode = ({ val, id }: DepartmentCodeInfo) => {
  ...
  dispatchRules.firstClass = [
    { required: true, message: "事项类别不能为空", trigger: "change",validator: validateFirstClass },
  ];
  dispatchRules.deadline = [
