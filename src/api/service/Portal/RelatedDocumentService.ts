...
export interface RelatedDocumentInterface extends BaseInterface<PortalModel> { 
    updateStatus(id: number, status: number): Promise<Response>

}

export class RelatedDocumentService implements RelatedDocumentInterface {
    protected baseUlr: string = 'relatedDocument'
    private request
    constructor() {
