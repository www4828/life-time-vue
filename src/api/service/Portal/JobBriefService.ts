...
export interface JobBriefInterface extends BaseInterface<PortalModel> {
    updateStatus(id: number, status: number): Promise<Response>
}

export class JobBriefService implements JobBriefInterface {
    protected baseUlr: string = 'jobBrief'
    private request
    constructor() {
